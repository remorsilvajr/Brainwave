  ...
  return (
    <div className="p-8 max-w-2xl mx-auto space-y-8">
      ...
      <div className="bg-white p-8 rounded-3xl border border-stone-100 shadow-sm space-y-8">
        <div>
          <h2 className="text-3xl font-bold text-stone-900 tracking-tight">{assignment.title}</h2>
        ...
        <form action={formAction} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className={`border-2 border-dashed rounded-2xl p-8 text-center transition-colors ${
              selectedFileName ? 'border-amber-200 bg-amber-50' : 'border-stone-100 hover:border-amber-200'
            }`}>
              <input 
                type="file" 
                name="file"
              ...
              <label htmlFor="file-upload" className="cursor-pointer">
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-sm font-bold text-stone-800 max-w-xs truncate px-4">
                    {selectedFileName ? selectedFileName : "Click to browse or drag & drop"}
                  </p>
